...
# Brasero: burn cds and dvds
# Gnome-tweak-tool: to customize the Gnome interface
# LmSensors: to monitor device temperature
# Gimp: to edit images
# Libreoffice: suite office
# VLC: player
sudo apt -y install curl git unrar vim guvcview transmission htop brasero gnome-tweak-tool lm-sensors gimp gparted libreoffice vlc
